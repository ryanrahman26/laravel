...
<head>
  ...
  <link rel="stylesheet" href="{{ asset("/AdminLTE-2.4.15/dist/css/skins/skin-blue.min.css") }}">
        ...
        @auth
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{ asset("/AdminLTE-2.4.15/dist/img/user2-160x160.jpg") }}" class="user-image" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @auth
          <li>
            <a href="{{ route('users.index') }}"><i class="fa fa-link"></i> <span>User</span></a>
          </li>
          <li>
            <a href="{{ route('employees.index') }}"><i class="fa fa-link"></i> <span>Employee</span></a>
          </li>
          <li>
            <a href="{{ route('companies.index') }}"><i class="fa fa-link"></i> <span>Company</span></a>
          </li>
          <li>
            <a href="{{ route('webservices.index') }}"><i class="fa fa-link"></i> <span>Web Service</span></a>
          </li>
        @endauth
      </ul>
      <!-- /.sidebar-menu -->
